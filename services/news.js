                ...
                const briefing = {
                    robotics: [
                        { 
                            ...
                            source: 'RoboTech Daily',
                            url: 'https://example.com/robotics/humanoid',
                            date: today
                        },
                        { 
                            title: { en: 'Global Robot Sales Surge 15%', ko: '전 세계 로봇 판매량 15% 급증' }, 
                            summary: { en: 'Industrial automation adoption is accelerating across Southeast Asia.', ko: '동남아시아 전역에서 산업 자동화 도입이 가속화도고 있습니다.' }, 
                            source: 'Global Markets',
                            url: 'https://example.com/robotics/sales',
                            date: today
                        }
                    ],
                    automotive: [
                        { 
                            ...
                            source: 'AutoNews',
                            url: 'https://example.com/auto/ev-range',
                            date: today
                        },
                        { 
                            ...
                            url: 'https://example.com/auto/autonomous',
                            date: today
                        }
                    ],
                    battery: [
                        { 
                            ...
                            url: 'https://example.com/battery/li-sulfur',
                            date: today
                        },
                        { 
                            ...
                            source: 'Power Digest',
                            url: 'https://example.com/battery/gigafactory',
                            date: today
                        }
                    ],
                    wiring: [
                        { 
                            ...
                            source: 'Wire & Cable',
                            url: 'https://example.com/wiring/hv-standards',
                            date: today
                        },
                        { 
                            ...
                            source: 'Tech Review',
                            url: 'https://example.com/wiring/lightweight',
                            date: today
                        }
                    ],
                    automation: [
                        { 
                            ...
                            url: 'https://example.com/automation/ai-factory',
                            date: today
                        },
                        { 
                            ...
                            source: 'SME News',
                            url: 'https://example.com/automation/cobots',
                            date: today
                        }
                    ]
                };
